        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    BorderColor =10921638
                    Name ="F_MainTradOrg"
                    SourceObject ="Form.F_MainTradOrg"
                    GridlineColor =10921638
                ...
                Begin TextBox
                    ...
                    ForeColor =4210752
                    Name ="Texte5"
                    ControlSource ="=[F_MainTradOrg].[Form]![Trad_ID]"
                    GridlineColor =10921638
...
Private Sub zlApps_AfterUpdate()
    ...
    Me.F_MainTradOrg.Form.RecordSource = sSql

    Me.img_Langue.Picture = AfficheFlag(Me.F_MainTradOrg.Form![LangueCode].Value)

End Sub

Private Sub zlLangues_AfterUpdate()
    Me.imgLangTrad.Picture = AfficheFlag(Me.zlLangues)
End Sub
